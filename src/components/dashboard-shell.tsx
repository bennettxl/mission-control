        ...
        <nav className="mt-8 flex-1 space-y-0.5 px-3">
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                <item.icon size={18} className={active ? "text-red-500" : "text-white/40"} />
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  active ? "text-red-500" : "text-white/35"
                )}
              >
                <item.icon size={20} className={active ? "text-red-500" : "text-white/35"} />
                <span>{item.label}</span>
                {active && (
                  <div className="h-0.5 w-4 rounded-full bg-red-500" />
                )}
              </Link>
            );
          })}
